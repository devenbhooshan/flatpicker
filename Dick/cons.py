...
urls= {'commonfloor':{ 'bng' : 'http://www.commonfloor.com/apartments-for-rent-in-bangalore/cfct-bangalore' }
}
...
commonfloor_location_xpath ="//span[@class='details-item-value address']"
